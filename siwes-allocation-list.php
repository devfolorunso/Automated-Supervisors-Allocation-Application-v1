...
<head>
  ...
  <meta name="author" content="">
   ...
   <title>Admin - Generate SIWES LIST</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Generate SIWES Allocation List</h1>
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">GENERATE SIWES ALLOCATION LIST</h6>
        ...
        <hr>
            <!-- Content Row -->
                  <!-- Page Heading -->
          <!-- DataTales Example -->
          <?php $session = input::get('session');?>
          <div class="row">
            <div class="col-md-2"></div>
          <div class="card shadow mb-4 col-md-8">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">SIWES ALLOCATION LIST</h6>
              <a class="float-right" href="siwes-report.php?session=<?php echo $session;?>">DOWNLOAD LIST <i class="fa fa-download"></i></a>
            </div>
            <div class="card-body">
                ...
                ?>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <?php echo $generateSiwes->alloc_id;?>
                     ...
                     <td>
                        <?php echo $generateSiwes->level .'I';?>
                      </td>

                      <td>
                        <?php echo $generateSiwes->category;?>
                      </td>
                    </tr>
                <?php
              }
