...
<head>
  ...
  <meta name="author" content="">
   ...
   <title>Admin - Allocate Students To Supervisors</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Allocate Students < - > Supervisors</h1>
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">ALLOCATE PROJECT/SEMINAR STUDENTS TO SUPERVISORS</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-users text-black"></i> -> <i class="fas fa-user text-black"></i>
                    </a>
                  </div>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                    <?php include 'process/allocateProjectSeminarProcess.php'
                    ?>        
        <form class="user" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="session">
                      <option>PLEASE CHOOSE SESSION</option>
                      <option value="s20182019">20182019</option>
                    </select> 
                </div>
        ...
        <hr>
              <!-- Content Row -->
          <div class="card shadow mb-4" id="count">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Supervisors With Number Of Students Allocated</h6>
            </div>
            <div class="card-body">
          <div class="row">
            <?php include'countSeminarProjectSup.php';?>
          </div>
