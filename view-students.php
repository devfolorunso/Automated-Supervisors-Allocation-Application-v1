    ...
    if ( $session == $s20172018)
    {
            ...
            <span class="sr-only">Error:</span><marquee>TABLE IS EMPTY!!!  TABLE IS EMPTY!! TABLE IS EMPTY!!TABLE IS EMPTY!!</marquee></div>';
                ...
                ?>
                   <script>
              setTimeout(function(){
              window.location.href= "view-students.php#dataTable";
              }, 700);
              </script>
                  <thead>
                    <tr>
                ...
                ?>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <?php echo $getStudents->id;?>
                          
                      </td>
    
                      <td>
                        <?php echo $getStudents->surname;?>
                          
                      </td>
    
                      <td>
                        <?php echo $getStudents->firstname;?>
                          
                      </td>
    
                      <td>
                        <?php echo $getStudents->othername;?>
                      </td>

                     <td>
                        <?php echo $getStudents->matric_no;?>
                      </td>

                      <td>
                        <?php echo $getStudents->level;?>
                      </td>

                      <td>
                        <?php echo $getStudents->programme;?>
                      </td>
                    </tr>
                <?php
              }
           ...
           echo '<div class="alert alert-warning text-capitalize" role="alert">
            <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
            <span class="sr-only">Error:</span><marquee><b>PLS SELECT A SESSION</b></marquee></div>';
        }
