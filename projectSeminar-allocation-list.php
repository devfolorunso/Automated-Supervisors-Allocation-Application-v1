...
<head>
  ...
  <meta name="author" content="">
   ...
   <title>Admin - View Project/Seminar Allocation List</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Generate Allocated Project Student Supervision List</h1>
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">GENERATE PROJECT/SEMINAR ALLOCATION LIST</h6>
        ...
        <hr>
          ...
          <div class="card shadow mb-4 col-md-8">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">PROJECT/SEMINAR ALLOCATION LIST</h6>
              <a class="float-right" href="projectSeminar-report.php?session=<?php echo $session;?>&&level=<?php echo $level;?>&&programme=<?php echo $programme;?>">DOWNLOAD LIST <i class="fa fa-download"></i></a>
            </div>
            <div class="card-body">
                ...
                ?>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <?php echo $generatePseminar->alloc_id;?>
                     ...
                     <td>
                      ...
                      <td>
                        <?php echo $generatePseminar->category;?>
                      </td>
                    </tr>
                <?php
              }
