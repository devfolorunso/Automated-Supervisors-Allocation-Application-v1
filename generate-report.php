     ...
     <!-- Main Content -->
      ...
      <!-- Earnings (Monthly) Card Example -->
            <div class="col-md-6 mb-4">
              ...
              <a href="siwes-allocation-list.php">
                <div class="card-body">
                  ...
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col mr-2">
                      ...
                      <div class="text-s font-weight-bold text-success text-uppercase mb-1">SIWES ALLOCATION LIST 
                      </div>
              
                    </div>
              
                    <div class="col-auto">
                      <i class="fas  fa-users fa-2x text-black"></i> -> <i class="fas  fa-list fa-2x text-black"></i>
                    </div>
          ...
          <!-- Earnings (Monthly) Card Example -->
            <div class="col-md-6 mb-4">
              ...
              <div class="card shadow h-100 py-5">
              <a href="projectseminar-allocation-list.php">
                <div class="card-body">
                  ...
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col mr-2">
                      ...
                      <div class="text-s font-weight-bold text-success text-uppercase mb-1">PROJECT / SEMINAR ALLOCATION LIST
                      </div>
