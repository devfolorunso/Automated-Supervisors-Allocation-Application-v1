...
<head>
  ...
  <meta name="author" content="">
   ...
   <title>Admin - Input Supervisors</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Input Supervisors</h1>
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Input Supervisors</h6>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                        <?php 
                        require 'process/inputsupervisorsProcess.php';
                        ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Surname</label>
                        <input type="text" placeholder="Lecturer's Surname" class="form-control" name="surname">
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="Lecturer's Firstname" class="form-control" name="firstname">
                      </div>
